...
public class Main3 {
	...
	Main3() throws InterruptedException {
		...
		while (true) {
			...
			Image floor1 = Toolkit.getDefaultToolkit()
					.getImage(gc.getClass().getClassLoader().getResource("images/stage3bg2.png"));

			Image bg2 = Toolkit.getDefaultToolkit()
					.getImage(gc.getClass().getClassLoader().getResource("images/stage1bg1.png"));
			Image floor2 = Toolkit.getDefaultToolkit()
					.getImage(gc.getClass().getClassLoader().getResource("images/stage3bg2.png"));
			...
			Image j2obstacles = Toolkit.getDefaultToolkit()
					.getImage(gc.getClass().getClassLoader().getResource("images/stage1ob_j1.png"));
			Image s2obstacles = Toolkit.getDefaultToolkit()
					.getImage(gc.getClass().getClassLoader().getResource("images/stage1ob_s1.png"));
			...
			while (true) {
				synchronized (gc) {
					...
					gc.drawImage(bg1, bgx, 0, 1500, 400);
					gc.drawImage(bg1, bgx + 1490, 0, 1500, 400);

					// Drawing floor on loop
					gc.drawImage(floor1, floorx, 250, 1000, 150);
					gc.drawImage(floor1, floorx + 990, 250, 1000, 150);
			...
			while (true) {
				synchronized (gc) {
					...
					// Drawing backgrounds, two of same image on loop
					gc.drawImage(bg2, bgx, 0, 1500, 400);
					gc.drawImage(bg2, bgx + 1490, 0, 1500, 400);

					// Drawing floor on loop
					gc.drawImage(floor2, floorx, 250, 1000, 150);
					gc.drawImage(floor2, floorx + 990, 250, 1000, 150);
					...
					// Drawing single jump obstacles
					for (int i = 0; i < jobx.length; i++) {
						gc.drawImage(j2obstacles, jobx[i], joby, jobw, jobh);
						if (collision_detection(COOKIEX, cookiey, COOKIEW, COOKIEH, jobx[i], joby, jobw, jobh)) {
							hitob = true;
					...
					// Drawing slide obstacles
					for (int i = 0; i < sobx.length; i++) {
						gc.drawImage(s2obstacles, sobx[i], soby, sobw, sobh);
						if (collision_detection(COOKIEX, cookiey, COOKIEW, COOKIEH, sobx[i], soby, sobw, sobh)) {
							hitob = true;// checks for collision
						}
					}
